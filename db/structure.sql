...
CREATE TABLE "agents" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "email" varchar NOT NULL, "name" varchar NOT NULL, "password_digest" varchar NOT NULL, "role" varchar DEFAULT 'user' NOT NULL, "locale" varchar DEFAULT 'en' NOT NULL, "timezone" varchar DEFAULT 'UTC' NOT NULL, "notify_prefs" json DEFAULT '{}' NOT NULL, "session_token" varchar NOT NULL, "last_seen_at" datetime(6), "created_at" datetime(6) NOT NULL, "updated_at" datetime(6) NOT NULL, "muted_mailbox_ids" json DEFAULT '[]' NOT NULL /*application='Flow'*/, "signature" text /*application='Flow'*/, "otp_secret" varchar /*application='Flow'*/, "otp_required" boolean DEFAULT FALSE NOT NULL /*application='Flow'*/);
